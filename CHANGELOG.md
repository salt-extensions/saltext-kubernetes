...
- Update autodocs to use module names instead of virtual names to help with documentation clarity. [#43](https://github.com/salt-extensions/saltext-kubernetes/issues/43)
