...
The saltext-kubernetes project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-kubernetes.git
...
* Writing blog posts
* Sharing your experiences using Salt + Kubernetes
  on social media
...
[docs]: https://salt-extensions.github.io/saltext-kubernetes/
